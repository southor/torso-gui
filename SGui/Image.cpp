...
namespace SGui
{
	...
	Image::Image(RenderContext *renderContext, const fschar *fileName, Pos pos, Vec size, TxtrCoord posWithinTxtr, TxtrCoord sizeWithinTxtr, int operations1, int operations2)
		: RenderObj(pos, size), txtrId(txtrId)
	{
	...
	Image::Image(RenderContext *renderContext, const fschar *fileName, Pos pos, Vec size, int operations1, int operations2)
